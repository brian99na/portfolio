            ...
            <section className='home-25' >
                ...
                <div className='experience-1'>
                    ...
                    <div className={`experience-1-dropdown ${experienceOneOpen ? 'experience-dropdown-open' : ''}`}>
                        <p><strong>• Lead UX engineering efforts</strong> in improving desktop app usability and address customer concerns surrounding the Selective Sync desktop app feature. Managed complete process of collaborating w/ design, code implementation in TypeScript/React/Python, metrics, and feature rollout. Over the span of 2 months, customer experience tickets related to Selective Sync were reduced by 60%.
                        <br /><br /><strong>• Lead engineering efforts</strong> for a revamp to the Desktop App’s Tray design which aimed at improving engagement and retention of users on the Desktop App. Handled code implementation in TypeScript/React/Python, metrics, and rollout. Redesign focused on the increased exposure of the sharing and search features, both of which saw increase of activity by 141% and 41% respectively.
                        <br /><br /><strong>• Conducted a variety of UX experiments</strong> on multiple Dropbox products including Backup, FSS, and Sync. Took ownership of complete process of feature gating, implementation, logging, monitoring metrics, A/B testing, rollout, and GA of feature.
